...
Page({
  ...
  fetchServiceData: function () {  //获取服务数据
    ...
    // const newlist = [];
    var param = { "page": this.data.page, "rows": perpage, 'faultInfo.original': wx.getStorageSync('userInfo').companyId };
    ...
    app.webCall(app.serviceCode["HISTORY_RECORD"], param,
  ...
  conditionSearch: function () {  //获取服务数据
    ...
    var param = {
      "page": 1,
      "rows": perpage,
      'faultInfo.original': wx.getStorageSync('userInfo').companyId,
