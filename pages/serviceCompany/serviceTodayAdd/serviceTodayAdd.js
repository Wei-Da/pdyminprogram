...
Page({
  ...
  fetchServiceData: function () {  //获取服务数据
    ...
    // const newlist = [];
    var param = { "page": this.data.page, "rows": perpage, 'faultInfo.personid': wx.getStorageSync('userInfo').id, "type":"1"};
  ...
  keyWordsSearch: function () {
    wx.navigateTo({
      url: "../../keySearch/keySearch?path=serviceTodayAdd&&param=faultInfo.personid&&mUrl=ENGINEER_HISTORY_RECORD&&type='1'&&role=2",
    })
  },
