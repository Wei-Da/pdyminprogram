...
Page({
  ...
  onLoad: function (options) {
    ...
    if (wx.getStorageSync('recordHistory')!=""){
        this.setData({
          recordHistory: wx.getStorageSync('recordHistory'),
          hasRecord: true
        })
    }
  },
  ...
  sortData: function (keyword) {
    ...
    wx.setStorageSync('recordHistory', arrangRecord);
    this.setData({
  ...
  chooseDevice:function(e){
    wx.setStorageSync("deviceIndex", e.currentTarget.dataset.index)
    wx.navigateBack({
  ...
  chooseSerachDevice:function(e){
    wx.setStorageSync("deviceIndex", this.data.searchDeviceList[e.currentTarget.dataset.index].index)
    wx.navigateBack({
