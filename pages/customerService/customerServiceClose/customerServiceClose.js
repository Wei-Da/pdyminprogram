// pages/customerService/customerServiceClose/customerServiceClose.js
var app = getApp()
Page({
  ...
  fetchServiceData: function () {  //获取服务数据
    ...
    app.webCall(app.serviceCode["SERVICE_CLOSE_QUERY"], param,
  ...
  keyWordsSearch: function () {
    wx.navigateTo({
      url: "../../keySearch/keySearch?path=customerServiceClose&&param=''&&mUrl=SERVICE_CLOSE_QUERY&&type=''&&role=1",
    })
  },
