// pages/customerService/faultRecord/faultRecord.js
var app = getApp()
...
Page({
  ...
  fetchServiceData: function () {  //获取服务数据
    ...
    // const newlist = [];
    var param = { "page": this.data.page, "rows": perpage, 'faultInfo.companyid': wx.getStorageSync('userInfo').companyId,'type':'5' };
