// pages/serviceCompany/waitService/waitService.js
var app = getApp()
Page({
  ...
  fetchServiceData: function () {  //获取服务数据
    ...
    app.webCall(app.serviceCode["GET_WAIT_SERVICE"], param,
  ...
  keyWordsSearch: function () {
    wx.navigateTo({
      url: "../../keySearch/keySearch?path=customerWaitService&&param=faultInfo.personid&&mUrl=GET_WAIT_SERVICE&&type=''&&type=1",
    })
  },
