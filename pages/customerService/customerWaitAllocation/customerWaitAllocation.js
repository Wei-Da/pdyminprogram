// pages/customerService/customerWaitAllocation/customerWaitAllocation.js
var app = getApp()
Page({
  ...
  keyWordsSearch:function(){
    wx.navigateTo({
      url: "../../keySearch/keySearch?path=customerWaitAllocation&&param=faultInfo.sysuserid&&mUrl=TABLE_QUERY_SERVICE&&type=''&&role=1",
    })
  },
