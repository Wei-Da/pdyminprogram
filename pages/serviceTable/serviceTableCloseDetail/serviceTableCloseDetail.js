...
Page({
  ...
  data: {
    ...
    actionSheetItems: [
      { bindtap: 'ServiceEvaluation', txt: '服务客评' },
  ...
  getServiceDetail: function () {
    ...
    var that = this;
    var param = { "faultInfo.faultId": this.data.faultId, "faultInfo.serviceid": this.data.serviceId, "faultInfo.equipmentId": this.data.faultIp, "processId": this.data.processId, "processPerId": this.data.perId  };
    app.webCall(app.serviceCode["GET_SERVICE_DETAIL_JIA"], param,
  ...
  bindServiceEvaluation: function () {
    this.setData({
      actionSheetHidden: !this.data.actionSheetHidden
    })
    wx.redirectTo({
      url: '../clientEvaluate/clientEvaluate?faultId=' + this.data.faultInfo.faultId + '&&repairmanName=' + this.data.faultInfo.repairmanName + '&&repairmanPhone=' + this.data.faultInfo.repairmanPhone + '&&companyId=' + this.data.faultInfo.companyId + '&weight=' + this.data.faultInfo.weight + '&personId=' + this.data.faultInfo.personId + '&projectId=' + this.data.faultInfo.projectId + '&serviceCompanyId=' + this.data.faultInfo.serviceCompanyId,
    })
  },
  ...
  modalChange: function () {
    ...
    var param = {
      ...
      "faultInfo.faultContent": this.data.faultInfo.faultContent,
      'userId': wx.getStorageSync('userInfo').id,
    }
    app.webCall(app.serviceCode["SERVICE_CLOSE"], param,
      function onSuccess(res) {
        wx.redirectTo({
          url: '../serviceTableDeal/serviceTableDeal',
        })
