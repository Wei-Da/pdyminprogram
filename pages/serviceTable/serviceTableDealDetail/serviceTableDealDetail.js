...
Page({
  ...
  bindServiceChange: function () {
    ...
    wx.redirectTo({
      url: '../serviceChangePerson/serviceChangePerson?personId=' + this.data.faultInfo.personId + '&&personName=' + this.data.faultInfo.personName + '&&fauleEndDate=' + this.data.faultInfo.fauleEndDate+'&&faultId='+this.data.faultInfo.faultId,
    })
  },
