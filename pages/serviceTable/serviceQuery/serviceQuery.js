...
var stateLevel = { '0': '', '1': '1', '2': '3', '3': '5', '4': '7', '5': '9' };
Page({
  ...
  data: {
    ...
    serviceStates: ['请选择' , '未分配', '已分配', '工程师已确认', '已完成','已客评'],
    serviceStateIndex:0,
    companyNames:[],
    companyNameIndex:0,
    companyInfos:null,
  ...
  fetchServiceData: function () {  //获取服务数据
    ...
    if(this.data.isConditionSearch){
      ...
      param['faultInfo.faultStatus'] = stateLevel[this.data.serviceStateIndex];
  ...
  conditionSearch: function () {  //获取服务数据
    ...
    var param = { //faultInfo.companyid
      ...
      "faultInfo.faultStatus": stateLevel[this.data.serviceStateIndex],
